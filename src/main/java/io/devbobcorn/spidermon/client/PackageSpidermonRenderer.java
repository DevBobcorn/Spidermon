...
public class PackageSpidermonRenderer extends SmartBlockEntityRenderer<PackageSpidermonBlockEntity> {
	...
	protected void renderSafe(PackageSpidermonBlockEntity blockEntity, float partialTicks, PoseStack ms,
		...
		SuperByteBuffer body = CachedBuffers.partial(PackageSpidermonPartialModels.PACKAGE_SPIDERMON_BODY, blockEntity.getBlockState());
		...
		SuperByteBuffer head = CachedBuffers.partial(
			blockEntity.goggles ? PackageSpidermonPartialModels.PACKAGE_SPIDERMON_SPIDERMON_HEAD_GOGGLES : PackageSpidermonPartialModels.PACKAGE_SPIDERMON_HEAD,
		...
		SuperByteBuffer tongue = CachedBuffers.partial(PackageSpidermonPartialModels.PACKAGE_SPIDERMON_TONGUE, blockEntity.getBlockState());
