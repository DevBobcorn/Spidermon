...
public class PackageSpidermonPartialModels {
    ...
    public static final PartialModel PACKAGE_SPIDERMON_BODY_GOGGLES =
        PartialModel.of(ResourceLocation.fromNamespaceAndPath(SpidermonMod.MODID, "block/package_spidermon/body_goggles"));
